...
@Epic("HU-006101 Login")
@Feature("POST /api/v1/authentication/login")
@DisplayName("HU-006101 Login")
@Owner("aquiles.armenta")
class HU006101Login extends BaseTest {

    private static final String CATALOG = "scenarios/catalog/login-scenarios.txt";
