...
@Epic("curp-validation")
@Feature("POST /api/v1/customers/curp-validation")
@DisplayName("curp-validation")
@Owner("aquiles.armenta")
class HUCurpValidation extends BaseTest {

    private static final String CATALOG = "scenarios/catalog/curp-validation-scenarios.txt";
